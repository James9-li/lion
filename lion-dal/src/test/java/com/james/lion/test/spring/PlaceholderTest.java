package com.james.lion.test.spring;

import com.james.lion.test.entity.Person;
import com.james.lion.test.placeholder.LionPlaceholder;
...
public class PlaceholderTest {
    ...
    public void testPlaceholder() {
        ...
        System.out.println(lionPlaceholder.getProperty("name", "james") + ":"
                + lionPlaceholder.getProperty("age", "25") + ":"
                + lionPlaceholder.getProperty("lion", "娃哈哈"));
        System.out.println(lionPlaceholder.getProperty("name2", "james") + ":"

...
<#-- 添加项目的输入框 -->
<div id="lion-add-project-dialog" class="modal fade">
    <div class="modal-dialog" style="margin: 250px auto;">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding: 20px 70px;">
                <form id="lion-add-project-dialog-form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <span class="input-group-addon" id="projectName_span"></span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="mapDesc" placeholder="value" value=""
                                   name="mapDesc">
                        </div>
                    </div>
                    <div class="form-group">

...
<#-- 删除的输入框 -->
<div id="lion-delete-dialog" class="modal fade">
    <div class="modal-dialog" style="margin: 250px auto;">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding: 20px 70px;">
                <form id="lion-delete-dialog-form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input readonly="readonly" type="text" class="form-control" id="mapValue"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input readonly="readonly" type="text" class="form-control" id="mapDesc"
                    ...
                    <div class="form-group">
                        ...
                        <div id="lazy" class="col-sm-10">
                            <label class="radio-inline disabled">
                                <input type="radio" name="lazy" value="1" disabled="disabled"> 是
                            </label>
                            <label class="radio-inline disabled">
                                <input type="radio" name="lazy" checked="checked" value="0" disabled="disabled"> 否
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="deleteBtn">删除
                </button>
            </div>
        </div>
    </div>
